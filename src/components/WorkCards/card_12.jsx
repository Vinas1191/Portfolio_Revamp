...
const card_12 = () => {
  return (
    ...
    <div className="w-auto h-4/5 bg-[#D4ECDD] text-[#112031] flex flex-wrap items-center rounded-[30px] overflow-hidden cursor-pointer pl-[80px] max-sm:py-10 max-sm:px-3 max-sm:m-2 mb-5 transition transform 0.3s ease-in-out hover:zoom">
      <div className="w-auto flex flex-wrap">
        <div className="lg:w-7/12 flex flex-col justify-between py-[80px] max-md:items-center">
          <div>
          <h2 className="font-secondary text-[#112031] text-[30px] my-[30px] title">
          ...
          <div className="bg-[#112031] text-white flex flex-end w-fit items-center px-8 py-4 max-sm:px-24 rounded-full gap-3"
