...
const card_67 = () => {
  return (
    ...
    <div className="w-full flex max-md:flex-col lg:space-x-5">
      ...
      <div className="lg:w-1/2 bg-[#FF6584] flex flex-col flex-wrap items-center rounded-[30px] cursor-pointer transition transform 0.3s ease-in-out hover:zoom px-8 pt-10 max-md:mt-[18px] max-sm:pt-10 max-sm:px-3 max-sm:m-2">
        <div className="flex flex-col text-center">
